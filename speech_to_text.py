...
#Essentials
audio_filepath = # Local Path for Audio files
text_filepath = # Local Path for storing Transcripts
project_id = # Project ID
endpoint_id = # endpoint ID
json_key = # JSON key from your GCP account
...
def upload_to_bucket(blob_name, path_to_file, bucket_name):
    ...
    blob.upload_from_filename(path_to_file, timeout = (10,250))
